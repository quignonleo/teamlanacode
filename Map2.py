    ...
    while levels != [] and running:
        ...
        while what_it_replaces != '=' and running:
            ...
            if list_map[i_0][j_0] == "µ" :
                ...
                question = font.render("Vous voulez accéder à votre inventaire ? Pressez Y pour oui")
                screen.blit(question, (400, 10))
                pg.display.update()
                pg.time.delay(500)
                running2 = False
                for event in pg.event.get():
                ...
                while running2 : 
                    ...
                    pg.display.update()
                    screen.fill((0, 0, 0))
                    text = font.render("Pressez P pour revenir au jeu", 1, (255, 255, 255))
